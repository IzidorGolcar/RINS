...
ARGUMENTS = [
    ...
    DeclareLaunchArgument('map', default_value=PathJoinSubstitution([pkg_dis_tutorial3, 'maps', 'map_task2_blue.yaml']), description='Full path to map yaml file to load')
]
